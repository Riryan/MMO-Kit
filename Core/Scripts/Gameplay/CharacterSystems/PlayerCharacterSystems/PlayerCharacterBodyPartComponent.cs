...
namespace MultiplayerARPG
{
    public class PlayerCharacterBodyPartComponent : BaseGameEntityComponent<BasePlayerCharacterEntity>
    {
        ...
        public float GetSliderValue() => sliderValue;
        public float GetMinSliderValue() => minSliderValue;
        public float GetMaxSliderValue() => maxSliderValue;

        public void SetSliderValue(float value)
        {
            sliderValue = Mathf.Clamp(value, minSliderValue, maxSliderValue);
            // Optional: Apply value to model here
        }
