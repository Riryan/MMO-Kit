...
{
    public OptionData() : this(string.Empty, null, null) { }

    public OptionData(string text) : this(text, null, null) { }

    public OptionData(Sprite image) : this(string.Empty, image, null) { }
    ...
    // NEW — optional rich-text color (TMP only)
