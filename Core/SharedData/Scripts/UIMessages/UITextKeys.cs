namespace MultiplayerARPG
{
    public enum UITextKeys : ushort
    {
        ...
        //Cheat Detection messages
        UI_ERROR_CHEAT_DETECTED,
        UI_ERROR_CHEAT_DUPLICATE_ACTION,
        UI_ERROR_CHEAT_INVALID_REQUEST,
        UI_ERROR_TRY_AGAIN_LATER,
        UI_ERROR_DUPLICATE_ACTION,
